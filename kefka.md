...
タンク強攻撃は、「**MTフルバフ → STフルバフ → ST無敵 → MT無敵**」でうけることを前提に記載。<br>

<p class="mini-tip">
  <span class="mini-tip-label">補足：</span>
  PTによっては「MT無敵 → STフルバフ → MTフルバフ → ST無敵」など、変則的になることもある。<br>
</p>
...
<ol class="strategy-steps">
  <li>
    <strong>事前に鼓舞展開(ヒールが漏れやすいD3かD4を対象とする)</strong>
  </li>
  <li>
...
鼓舞展開＋疾風怒涛＋陣で耐えよう。周囲の軽減もしっかり入っていれば、重力踏みが3人割になっても余裕を持って耐えられる。<br>
<strong>陣と疾風怒涛は、半面焼きのエフェクトが出た後に使用すると、次の「裁きの光2」まで効果が残るのでおすすめ。</strong><br>
...
トラップを受ける直前か直後に使用してもらえば、重力踏みから「裁きの光2」まで効果が残る。<br>
...
ずびずばテレポの詠唱開始に合わせて、トラップ受けに備えた意気軒高のバリア※1を張っておく。<br>
PHがすでにバリア（Nセクまたはカレス）を張っている場合は、ここでの意気軒高は省略する。<br>

テレポ設置が終わったら、サモン・セラフィム → 陣 → 囁き → イルミ※2の順に使用する。<br>
トラップを受けたら、聖母（混乱）または睡魔の神気に備えてコンソレ1回目を使用する。<br>
<p class="mini-tip">
  <span class="mini-tip-label">補足1：</span>
  テレポを設置するたびに約2,000ダメージ受けてバリアが削られるが、気にしなくてよい。
</p>
<p class="mini-tip">
  <span class="mini-tip-label">補足2：</span>
...
素受けで約220,000ダメージ。<br>
コンソレ＋陣＋イルミに加えて、PHの軽減（サンサインまたはテンパ）があれば、半分くらいのダメージに抑えられるはず。<br>
...
素受けで約210,000ダメージ。<br>
以下の通り、戻しさえできればコンソレ＋イルミだけで耐えられる。<br>
...
神気で受けたダメージをしっかり戻すことが大事！<span class="text-red"><strong>不安な場合は不撓不屈、迅速意気を使用すること。</strong></span><br>
</div>
